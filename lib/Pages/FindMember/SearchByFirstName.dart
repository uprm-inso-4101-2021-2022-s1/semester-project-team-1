...
class SearchByFirstName extends StatefulWidget {
  @override
  _SearchByFirstNameState createState() => _SearchByFirstNameState();
}

class _SearchByFirstNameState extends State<SearchByFirstName> {
  String name = "";
                              ...
                              tileColor: (() {
                                if (DateTime.parse(data['nextPayDate'])
                                  ...
                                  return Colors.red[300];
                                    ...
                                    data['inquiry'] != null && data['inquiry'] != "empty") {
