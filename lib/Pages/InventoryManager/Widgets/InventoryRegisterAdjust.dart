...
class InventoryRegisterAdjust extends StatefulWidget {
  @override
  _InventoryRegisterAdjustState createState() =>
      _InventoryRegisterAdjustState();
}

class _InventoryRegisterAdjustState extends State<InventoryRegisterAdjust> {
  ...
  Future<void> subToSumOfDayInventory() {
    ...
    return sumOfDay
        .doc(updatedDateFormat)
        .update(
            {'SumOfInventory': FieldValue.increment(customMembershipAmount)})
        .then((value) => print("User Updated"))
        .catchError((error) => print("Failed to update user: $error"))
        .then((value) => {
              print("Manual Check-In Successful"),
